    ...
    run(roleId) {
        return __awaiter(this, void 0, void 0, function* () {
            try { // ToDo
                ...
                const response = yield axios_1.default.post(`${process.env.BASE_URI}/api/v1/message/send/${roleId}`, {
                //message: message
                }, utils_1.utils.set.bearer(__1.default.users[this.socket.id].token));
                console.log(response.data);
                __1.default.io.in(roleId.toString()).emit("roleCreate", response.data);
            }
            catch (err) {
