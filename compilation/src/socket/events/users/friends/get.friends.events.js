...
exports.FriendGetEvent = void 0;
const axios_1 = __importDefault(require("axios"));
const dotenv_1 = __importDefault(require("dotenv"));
const utils_1 = require("../../../utils");
const __1 = __importDefault(require("../../.."));
dotenv_1.default.config();
class FriendGetEvent {
    constructor(socket) {
        this.socket = socket;
    }
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                __1.default.io.to(this.socket.id).emit("friendGet", response.data.data);
            }
            catch (err) {
                console.log(err);
            }
...
exports.FriendGetEvent = FriendGetEvent;
