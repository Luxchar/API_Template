...
exports.getFriendsRequestsSent = void 0;
const database_1 = __importDefault(require("../../../database"));
const controller_1 = require("../../controller");
const utils_1 = __importDefault(require("../../../utils"));
const getFriendsRequestsSent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getFriendsRequestsSent = getFriendsRequestsSent;
