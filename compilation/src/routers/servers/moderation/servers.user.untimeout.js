...
exports.userUnTimeout = void 0;
const controller_1 = require("../../controller");
const emitter_client_1 = __importDefault(require("../../../client/emitter.client"));
const database_1 = __importDefault(require("../../../database"));
const utils_1 = __importDefault(require("../../../utils"));
const userUnTimeout = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    try {
        ...
        if (!Server.timeouts)
            throw "Server does not have timeouted users";
        ...
        if (!utils_1.default.FUNCTIONS.CHECK.SERVER.PERMISSIONS(User, Server, utils_1.default.CONSTANTS.SERVER.PERMISSIONS.ADMIN))
            throw "You do not have permission to untimeout users";
        // remove the user from the server members array of maps
        if ((_a = Server.timeouts) === null || _a === void 0 ? void 0 : _a.includes(parseInt(user_id)))
            throw "User is not timed out";
        (_b = Server.timeouts) === null || _b === void 0 ? void 0 : _b.splice(Server.timeouts.indexOf(parseInt(user_id)), 1);
        emitter_client_1.default.emit("updateUnTimeout", Server);
...
exports.userUnTimeout = userUnTimeout;
