...
const userUnban = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (Server.banned_users == null)
            throw "Server does not have any banned users";
        ...
        delete Server.banned_users[parseInt(user_id)];
        emitter_client_1.default.emit("updateUnban", Server);
