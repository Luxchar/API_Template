...
exports.userTimeout = void 0;
const controller_1 = require("../../controller");
const emitter_client_1 = __importDefault(require("../../../client/emitter.client"));
const database_1 = __importDefault(require("../../../database"));
const utils_1 = __importDefault(require("../../../utils"));
const userTimeout = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!utils_1.default.FUNCTIONS.CHECK.SERVER.PERMISSIONS(User, Server, utils_1.default.CONSTANTS.SERVER.PERMISSIONS.ADMIN))
            throw "You do not have permission to timeout users";
        // remove the user from the server members array of maps
        if (!Server.timeouts)
            Server.timeouts = [];
        delete Server.timeouts[parseInt(user_id)];
        emitter_client_1.default.emit("updateTimeout", Server);
